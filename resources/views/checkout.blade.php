                                    ...
                                    <div class="order-box" style="margin: 0 !important">
                                        ...
                                        <div class="sub-total">
                                            ...
                                            <div class="row">
                                                ...
                                                <input type="hidden" id="total_berat_barang" name="total_berat_barang"
                                                    value="{{ $total_berat }}">
                                            </div>
                                            <div class="row">
                                                <div class="col-6"
                                                ...
                                                <div class="col-6"
                                                    ...
                                                    <div id="shipping">
                                                        ...
                                                        <div class="shopping-option">
                                                            <input type="radio" name="shipping" id="REG" value="REG">
                                            ...
                                            <div class="row">
                                                ...
                                                <input type="hidden" id="biaya_kirimVal" name="biaya_kirim">
                                            </div>
                                        </div>
                                        <div>
                                            <div class="row">
                                                ...
                                                <input type="hidden" id="total_bayarVal" name="total_bayar">
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="modal-bg">
                            <div class="newslatter-main">
                                ...
                                <div class="imd-wrraper">
                                    <img src="../assets/images/layout-2/product/3.jpg" alt="newsletterimg"
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-xs-12">
                            <div class="quick-view-img">
                                <img src="../assets/images/layout-1/product/3.jpg" alt="" class="img-fluid bg-img">
                            </div>
                        </div>
