...
<head>
    ...
    <meta name="author" content="DebiruHouse">
    ...
    <link rel="stylesheet" type="text/css" href="/assets/css/custom_styles.css" media="screen" id="color">
...
<body class="bg-light">
                        ...
                        <div class="main-menu-block">
                            <div class="menu-left">
                                    ...
                                    <ul class="nav-slide">
                                        ...
                                        <li class="mor-slide-open">
                                            <ul>
                                                ...
                                                <li><a href="category-page(left-sidebar).html">Movies, Music </a></li>
                                                <li><a href="category-page(left-sidebar).html">Video Games</a></li>
                                                <li><a href="category-page(left-sidebar).html">Toys, Baby Products</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li>
                                ...
                                <div class="brand-logo logo-sm-center">
                                    <a href="/">
                                        <img src="/assets/images/logo2.png" class="img-fluid " alt="logo-header">
                                    </a>
                                </div>
                            </div>
                            <div class="menu-block">
                                <nav id="main-nav">
                                    ...
                                    <ul id="main-menu" class="sm pixelstrap sm-horizontal">
                                        ...
                                        <!--HOME-->
                                        <li>
                                            <a class="dark-menu-item" href="/">Beranda</a>
                                        </li>
                                        <!--HOME-END-->
                                        <!--about-->
                                        <li>
                                            <a class="dark-menu-item" href="/aboutus">Tentang Kami</a>
                                        </li>
                                        <!--about-menu-END-->
                                        <!--product-menu start-->
                                                ...
                                                <li>
                                                    <div class="container">
                                                        ...
                                                        <div class="row menu-banner">
                                                            <div class="col-lg-6">
                                                                <div>
                                                                    <img src="/assets/images/layout-5/menu-banner/1.jpg"
                                                                        alt="menu-banner" class="img-fluid">
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6">
                                                                <div>
                                                                    <img src="/assets/images/layout-5/menu-banner/2.jpg"
                                                                        alt="menu-banner" class="img-fluid">
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <!--s&k menu start-->
                                        <li>
                                            <a class="dark-menu-item" href="/tc">S&amp;K</a>
                                        </li>
                                        <!--s&k-menu end-->

                                        <!--privasi-menu start-->
                                        <li>
                                            <a class="dark-menu-item" href="/privasi">Privasi</a>
                                        </li>
                                        <!--privasi-menu end-->

                                        <!--faqs-menu start-->
                                        <li>
                                            <a class="dark-menu-item" href="/faqs">FAQs</a>
                                        </li>
                                        <!--faqs-menu end-->
                                    </ul>
                                </nav>
                            ...
                            <div class="menu-right">
                                <div class="icon-nav icon-block">
                                    <ul>
                                        ...
                                        @if (auth()->check())
                                            <li class="mobile-user">
                                               ...
                                               M451.001,482H451H61v-71.363C96.031,360.683,152.952,331,214.167,331h83.667c61.215,0,118.135,29.683,153.167,79.637V482z" />
                                                    ...
                                                    <span class="text-capitalize fw-bolder link-dark mx-1">
                                        ...
                                        @if (Auth::check())
                                            <li id="opencart" class="cart-block mobile-cart  item-count"
                                                onclick="openCart()">
                                                <a href="javascript:void(0)">
                                                    <svg enable-background="new 0 0 512 512" viewBox="0 0 512 512"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    @if (auth()->check())
                                                        <div id="count_cart" class="item-count-contain item-whtie item-md">
                                                            {{ auth()->user()->get_cart->count() }}
                                                        </div>
                                                    @endif
                                        ...
                                        @else
                                            <li class="cart-block mobile-cart  item-count" onclick="openAccount()">
                                                <a href="javascript:void(0)">
                                                    <svg enable-background="new 0 0 512 512" viewBox="0 0 512 512"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                            ...
                            <div class="category-right">
                                <div class="contact-block">
                                    <div>
                                        ...
                                        <span>call us<span>+62 815 19 3636 91</span></span>
                                    </div>
                                </div>
                                <div class="btn-group">
                        ...
                        <div class="footer-main">
                            <div class="footer-box">
                                ...
                                <div class="footer-contant">
                                    ...
                                    <p>Terpercaya Sejak 2009</p>
                                    <ul class="sosiyal">
                                        <li><a href="https://www.facebook.com/debiruhouse"><i
                                                    class="fa fa-facebook"></i></a></li>
                                        <li><a href="javascript:void(0)"><i class="fa fa-google-plus"></i></a></li>
                                        <li><a href="https://twitter.com/debiruhousecom/"><i
                                                    class="fa fa-twitter"></i></a></li>
                                        <li><a href="https://www.instagram.com/debiruhouse/"><i
                            ...
                            <div class="footer-box">
                                ...
                                <div class="footer-contant">
                                    <ul>
                                        @foreach ($etalase as $et)
                                            <li><a href="/etalase/{{ $et->etalase }}/1">{{ $et->etalase }}</a></li>
                                        @endforeach
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="footer-box">
                                ...
                                <div class="footer-contant">
                                    <ul class="contact-list">
                                        <li><i class="fa fa-phone"></i><span>+62 815 19 3636 91</span></li>
                                        <li style="text-transform: none;"><i
                                                class="fa fa-envelope-o"></i>care@debiruhouse.com</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-xl-6 col-md-8 col-sm-12">
                        <div class="footer-left">
                            <p>&copy; <?php echo date('Y'); ?> DebiruHouse. All Rights Reserved.</p>
                        </div>
                    </div>
                    <div class="col-xl-6 col-md-4 col-sm-12">
                        <div class="footer-right">
                            <ul class="payment">
                                <li><a href="javascript:void(0)"><img src="/assets/images/layout-1/pay/1.png"
                                            class="img-fluid" alt="pay"></a></li>
                                <li><a href="javascript:void(0)"><img src="/assets/images/layout-1/pay/2.png"
                                            class="img-fluid" alt="pay"></a></li>
                                <li><a href="javascript:void(0)"><img src="/assets/images/layout-1/pay/3.png"
                                            class="img-fluid" alt="pay"></a></li>
                                <li><a href="javascript:void(0)"><img src="/assets/images/layout-1/pay/4.png"
                                            class="img-fluid" alt="pay"></a></li>
                                <li><a href="javascript:void(0)"><img src="/assets/images/layout-1/pay/5.png"
                                            class="img-fluid" alt="pay"></a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 rtl-text">
                            <div class="product-right">
                                ...
                                <div id="qv-product-info" class="pro-group">
                                    <h6 class="product-title">product infomation</h6>
                                    <p></p>
                                </div>
                                <div class="pro-group pb-0">
                                    <div id="qv-varian"></div>
    ...
    <div class="modal fade bd-example-modal-lg theme-modal pro-edit-modal" id="edit-product" tabindex="-1"
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content ">
                <div class="modal-body" id="modal_edit_product">
    ...
    <div id="cart_side" class="add_to_cart right ">
        ...
        <div class="cart-inner">
            ...
            <div id="cart_product" class="cart_media">
            </div>
        </div>
    </div>
    <!-- Add to cart bar end-->
    ...
    <div class="modal fade bd-example-modal-lg theme-modal cart-modal" id="addtocart" tabindex="-1" role="dialog"
        aria-hidden="true">
        <div id="modal_cart_etalase" class="modal-dialog modal-lg modal-dialog-centered" role="document">
        ...
        <div class="cart-inner">
            ...
            <form class="theme-form" method="post" action="/dologin">
                ...
                <div class="accout-fwd">
                    <a href="/forgotpassword" class="d-block">
    ...
    <div class="product-notification" id="dismiss">
        ...
        <div class="media">
            <img class="me-2" src="/assets/images/layout-1/product/5.jpg" alt="Generic placeholder image">
            <div class="media-body">
