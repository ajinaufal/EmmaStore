...
@section('page_title')
    {{ ucwords($product[0]->etalase . ' ' . strtolower($product[0]->nama)) }}
@endsection
@section('meta_desc')
    {{ ucwords($product[0]->etalase . ' ' . strtolower($product[0]->nama)) }}
@endsection
            ...
            <div class="row">
                <div class="col">
                    <div class="breadcrumb-contain">
                        <div>
                            <h2>{{ $product[0]->nama }}</h2>
                            <ul>
                                <li><a href="/">home</a></li>
                                <li><i class="fa fa-angle-double-right"></i></li>
                                <li><a href="javascript:void(0)">{{ $product[0]->nama }}</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="product-slick no-arrow">
                            <div><img src="/assets/images/products/parfum/{{ $product[0]->gambar1 }}" alt=""
                                    class="img-fluid  image_zoom_cls-0"></div>
                            <?php if(!empty($product[0]->gambar2)) { ?>
                            <div><img src="/assets/images/products/parfum/{{ $product[0]->gambar2 }}" alt=""
                                    class="img-fluid  image_zoom_cls-1"></div>
                            <?php } ?>
                            <?php if(!empty($product[0]->gambar3)) { ?>
                            <div><img src="/assets/images/products/parfum/{{ $product[0]->gambar3 }}" alt=""
                                    class="img-fluid  image_zoom_cls-1"></div>
                            <?php } ?>
                            <?php if(!empty($product[0]->gambar4)) { ?>
                            <div><img src="/assets/images/products/parfum/{{ $product[0]->gambar4 }}" alt=""
                                    class="img-fluid  image_zoom_cls-1"></div>
                            <?php } ?>
                            <?php if(!empty($product[0]->gambar5)) { ?>
                            <div><img src="/assets/images/products/parfum/{{ $product[0]->gambar5 }}" alt=""
                                    class="img-fluid  image_zoom_cls-1"></div>
                            <?php } ?>
                        </div>
                        <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="product-right product-description-box">
                            <div class="pro-group">
                                <h2>{{ $product[0]->nama }}</h2>
                                <ul class="pro-price">
                                    <?php if($product[0]->harga > 0) {
                                            if($product[0]->onsale > 0) { ?>
                                    <li>Rp. {{ number_format($product[0]->onsale) . '.00' }}</li>
                                    <li><span>Rp. {{ number_format($product[0]->harga) . '.00' }}</span></li>
                                    <li>{{ round((($product[0]->harga - $product[0]->onsale) / $product[0]->harga) * 100, 0) }}%
                                        off</li>
                                    <?php } else { ?>
                                    <li>Rp. {{ number_format($product[0]->harga) . '.00' }}</li>
                                    <?php } 
                                        } else { ?>
                                    <li>
                                        <?php if($product[0]->min_price == $product[0]->max_price) { ?>
                                        Rp. {{ number_format($product[0]->min_price) . '.00' }}
                                        <?php } else { ?>
                                        Rp. {{ number_format($product[0]->min_price) . '.00' }} - Rp.
                                        {{ number_format($product[0]->max_price) . '.00' }}
                                        <?php } ?>
                                    </li>
                                    <?php } ?>
                                </ul>
                                            ...
                                            <g>
                                                <g>
                                                    <path d="m412.65 107.667h-80.65v148.333l180-21.056v-.108z"
                                                        fill="#cce6ff"></path>
                                                    <path d="m332 234.944h180v158.722h-180z" fill="#cc295f"></path>
                                                </g>
                                                <g>
                                                    ...
                                                    <path d="m0 65 .001 96 186.267 20.333v-116.333z" fill="#fdcb02"></path>
                                                    <path
                                                        d="m235.314 265.667 29.905-104.667h-78.951l-15.601 52.333 15.601 52.334z"
                                                        fill="#cc295f"></path>
                                                    <path d="m.001 161h186.267v104.666h-186.267z" fill="#ff4d4d"></path>
                                                </g>
                                                <g>
                                                    <circle cx="122.667" cy="384" fill="#f9f9f9" r="48"></circle>
                                                    <path
                                                ...
                                                <g>
                                                    <circle cx="389.333" cy="384" fill="#eaf1ff" r="48"></circle>
                                                    <path
                    ...
                    <div class="col-lg-4">
                        <div class="product-right product-form-box">
                            ...
                            <div id="selectSize"
                                ...
                                <?php if(!empty($product_varian)) { ?>
                                <h6 class="product-title size-text"><span>
                                        <a href="" data-bs-toggle="modal" data-bs-target="#sizemodal">Variant
                                            Produk</a></span></h6>
                                ...
                                <h6 class="error-message">please select {{ $product_varian[0]->jenis }}</h6>
                                <div class="size-box">
                                    <ul>
                                        @foreach ($product_varian as $pv)
                                            @if ($pv->jenis == 'Ukuran')
                                                <li class="prod_var" data-harga="{{ $pv->harga }}"
                                                    data-onsale="{{ $pv->onsale }}">
                                                    <a onclick="variant_size_cart_detail('{{ $pv->id }}');"
                                                        href="javascript:void(0)">{{ $pv->nama }}</a>
                                                </li>
                                            @endif
                                        @endforeach
                                    </ul>
                                    ...
                                    <ul>
                                        @foreach ($product_varian as $pv)
                                            @if ($pv->jenis == 'Warna')
                                                @if ($pv->nama == 'White')
                                                    <li>
                                                        <div onclick="variant_color_cart_detail('{{ $pv->id }}')" class="color-1"></div>
                                                    </li>
                                                @elseif ($pv->nama == "Glossy Red")
                                                    <li>
                                                        <div onclick="variant_color_cart_detail('{{ $pv->id }}')" class="color-3"></div>
                                                    </li>
                                                @elseif ($pv->nama == "Purple")
                                                    <li>
                                                        <div onclick="variant_color_cart_detail('{{ $pv->id }}')" class="color-4"></div>
                                                    </li>
                                                @elseif ($pv->nama == "Tosca")
                                                    <li>
                                                        <div onclick="variant_color_cart_detail('{{ $pv->id }}')" class="color-5"></div>
                                                    </li>
                                                @elseif ($pv->nama == "Pink")
                                                    <li>
                                                        <div onclick="variant_color_cart_detail('{{ $pv->id }}')" class="color-6"></div>
                                                    </li>
                                                @elseif ($pv->nama == "Orange")
                                                    <li>
                                                        <div onclick="variant_color_cart_detail('{{ $pv->id }}')" class="color-7"></div>
                                                    </li>
                                                @elseif ($pv->nama == "Matte Red")
                                                    <li>
                                                        <div onclick="variant_color_cart_detail('{{ $pv->id }}')" class="color-2"></div>
                                                    </li>
                                                @endif
                                            @endif
                                        @endforeach
                                ...
                                <?php } ?>
                                <input type="hidden" id="variant_color_detail" name="variant_color_detail">
                                <input type="hidden" id="variant_size_detail" name="variant_size_detail">
                                <h6 class="product-title">quantity</h6>
                                <div class="qty-box">
                                    <div class="input-group">
                                        <button class="qty-minus"></button>
                                        <input id="total_detail" class="qty-adj form-control" type="number" value="1" />
                                        <button class="qty-plus"></button>
                                    </div>
                                </div>
                                <div class="product-buttons">
                                    <a href="javascript:void(0)" id="button_cart_detail" @if (Auth::check()) data-user_id="{{ auth()->user()->id }}" @endif
                                        data-id="{{ $product[0]->id }}" data-product_id="{{ $product[0]->id }}"
